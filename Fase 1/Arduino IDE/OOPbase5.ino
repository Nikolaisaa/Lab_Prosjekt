...
public:
    ...
    int* getSensorSpeedsFromHighestIndex(int theHighestIndex){
        int motorSpeeds[2] = {0,0};
        if(theHighestIndex < 4){
        motorSpeeds[0] = 0;
        motorSpeeds[1] = 255;
        }
        else if(theHighestIndex < 7){
            motorSpeeds[0] = 255;
            motorSpeeds[1] = 255;
        }
        else{
...
void loop() {
    ...
    motors.setMotorSpeed(so.getSensorSpeedsFromHighestIndex(highestSensorValueIndex));
    delay(50);
}
